...
export class StatistiqueService {
    ...
    getDashboard(start: string, end: string): Observable<StatistiqueResponse> {
        ...
        return this.http.get<StatistiqueResponse>(`${this.baseUrl}/dashboard`, { params });
    }
    ...
    getQuarterlyStats(year: number, quarter: number): Observable<StatistiqueResponse> {
        ...
        return this.http.get<StatistiqueResponse>(`${this.baseUrl}/quarterly`, { params });
    }

    getAnnualStats(year: number): Observable<StatistiqueResponse> {
        const params = new HttpParams().set('year', year);
        return this.http.get<StatistiqueResponse>(`${this.baseUrl}/annual`, { params });
    }
}